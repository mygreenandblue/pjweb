        ...
        <div class="breadcrumb_view">
            <ul class="breadcrumbs">
                <li>
                    ...
                    <span>FreeshipEXTRA đơn hàng từ 99K</span>
                </li>
            </ul><span class="clearfix"></span>
        </div>

        <div id="artContent" class="content-new">
            <h1 style="line-height: initial;font-size: 24px;margin-bottom: 20px;">FreeshipEXTRA đơn hàng từ 99K</h1>
            <div>
                <h3><strong><span style="color:rgb(0,128,128);"><img alt=""
                                src="https://mcdn.nhanh.vn/store/7239/artCT/45752/freeship.png"
                                style="width:32px;height:19px;">&nbsp;<span style="font-size:14px;">FREESHIP</span>EXTRA
                            - Miễn phí giao hàng nhanh! Shopping
                            tưng bừng, chẳng ngại nắng, chẳng ngại xa, chẳng ngại corona!</span></strong></h3>
                <p>Corona làm bạn ngại - không thể&nbsp;ra ngoài? Trời nắng, đường bụi&nbsp;làm bạn chỉ muốn ở nhà?
                    Đường xa làm bạn ngại đi?<br>
                    Bạn khó tới trực tiếp&nbsp;các cửa hàng của Tô nhưng vẫn muốn sở hữu những sản phẩm&nbsp;mới cực
                    kỳ đáng yêu ở Tô nhưng&nbsp;lại ngại phí ship?<br>
                    &nbsp;Thấu hiểu điều đó,&nbsp;kết hợp với các hãng giao hàng Totoro Việt Nam đã&nbsp;thực hiện
                    chương trình miễn phí giao hàng&nbsp;cực cool:<br>
                    &nbsp;<span style="color:rgb(255,0,0);"><strong><span
                                style="font-size:14px;">FREESHIP</span>EXTRA&nbsp;- MIỄN PHÍ GIAO HÀNG NHANH muôn
                            nơi, Shopping tưng bừng&nbsp;chẳng ngại xa, chẳng ngại corona&nbsp;!</strong></span><br>
                    Chi tiết:</p>
                <p><strong style="color:rgb(255,0,0);">GIẢM PHÍ GIAO HÀNG&nbsp;50%++ với&nbsp;đơn hàng chỉ&nbsp;từ
                        ₫99.000</strong><strong>. Đặc biệt :</strong></p>
                <p>-&nbsp;<span style="color:rgb(255,0,0);"><strong>Miễn phí giao hàng
                            nhanh</strong></span>&nbsp;đối với đơn hàng nội thành&nbsp;Hà Nội, TP Hồ Chí Minh, Đà
                    Nẵng, Hải Phòng chỉ&nbsp;<span style="color:rgb(255,0,0);"><strong>từ ₫149.000</strong></span>
                </p>
                <p>-&nbsp;<span style="color:rgb(255,0,0);"><strong>Miễn phí giao hàng
                            nhanh</strong></span>&nbsp;đối với khách hàng&nbsp;các tỉnh thành khác với đơn
                    hàng&nbsp;<span style="color:rgb(255,0,0);"><strong>từ ₫249.000</strong></span></p>
                <p>Ngoài hình thức&nbsp;<span style="color:rgb(255,0,0);"><strong>Giao hàng
                            Nhanh</strong></span>&nbsp;(thời gian giao hàng 1-5 ngày tùy địa điểm người nhận),
                    Totoro còn có&nbsp;<span style="color:rgb(255,0,0);"><strong>Giao hàng Hỏa tốc&nbsp;(30P -
                            2H)</strong></span>&nbsp;trong khu vực nội thành Hà Nội, Hải Phòng, Đà Nẵng, TP
                    HCM&nbsp;đáp ứng nhu cầu mua hàng nhận ngay của khách hàng với chi phí giao hàng rất thấp.</p>
                <p>Woaaa&nbsp;shopping thả ga chẳng ngại xa, chẳng ngại corona ngay với&nbsp;<a
                        href="https://totoro.vn"><strong
                            style="color: #6e6e6e;">TOTORO.VN</strong></a>&nbsp;thôiii&nbsp;!!</p>
                <p><img alt="" src="https://mcdn.nhanh.vn/store/7239/artCT/45752/cover_4_2019.jpg"
                        style="width:640px;height:360px;"></p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>Ahh&nbsp;việc đặt hàng ship thì rất tiện nhưng&nbsp;nếu bạn muốn trải nghiệm trực tiếp sản
                    phẩm,&nbsp;<strong>Đừng quên ghé trực tiếp các cửa hàng của Tô nhé</strong>, cả một thiên đường
                    đồ cực kỳ dễ thương,&nbsp;tiện ích, chất lượng cao đang chờ bạn ở Tô&nbsp;đó. Khi mua trực tiếp
                    còn có nhiều chương trình khuyến mãi nữaaa, cực đã luônnn!!!</p>
                <p>&nbsp;</p>
                <p><span style="color:rgb(0,128,128);"><strong>CHUỖI CỬA HÀNG ĐỒ DÙNG TIỆN ÍCH - QUÀ
                            TẶNG&nbsp;TOTORO</strong></span></p>
                <ul>
                    <li><strong>Hà Nội</strong>
                        <ul>
                            <li>- 90 Xã Đàn, Q. Đống Đa&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;|&nbsp; ĐT:&nbsp; 096.247.1988</li>
                        </ul>
                    </li>
                    <li><strong>TP Hồ Chí Minh</strong>
                        <ul>
                            <li>- 560 Nguyễn Đình Chiểu, P.4, Q.3&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; |&nbsp;
                                ĐT:&nbsp; 090.247.1988</li>
                        </ul>
                    </li>
                    <li><strong>ĐÀ NẴNG</strong>
                        <ul>
                            <li>-&nbsp;123A&nbsp;Nguyễn Chí Thanh, Q. Hải Châu&nbsp; |&nbsp; ĐT:&nbsp; 082.247.1988
                            </li>
                        </ul>
                    </li>
                    <li><strong>HẢI PHÒNG</strong>
                        <ul>
                            <li>-&nbsp;233 Lê Lợi, Q. Ngô Quyền&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp;|&nbsp; ĐT: 092.247.1988&nbsp;</li>
                        </ul>
                    </li>
                </ul>
                <p><strong>Website đặt hàng</strong>:&nbsp;<a href="http://totoro.vn"
                        style="color: black;">totoro.vn</a><br><strong>Facebook</strong>:&nbsp;<a
                        href="http://fb.com/totoro1988" target="_blank" style="color: black;"
                        rel="noreferrer noopener">fb.com/totoro1988</a>&nbsp;- Instagram:&nbsp;<a
                        href="http://instagram.com/totoro.vn" target="_blank" rel="noreferrer noopener"
                        style="color: black;">instagram.com/totoro.vn</a></p>
                <p>&nbsp;</p>
            </div>
        </div>
